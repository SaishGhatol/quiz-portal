      ...
      <div className="flex justify-center items-center py-32">
        <div className="flex flex-col items-center">
          <div className="relative">
            <div className="h-16 w-16 rounded-full border-4 border-blue-100 opacity-30"></div>
            <div className="absolute top-0 h-16 w-16 rounded-full border-4 border-t-blue-900 border-r-transparent border-b-transparent border-l-transparent animate-spin"></div>
          </div>
          <p className="mt-6 text-blue-900 font-medium text-lg animate-pulse">Loading your dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:translate-y-1 transform">
          <div className="relative">
            ...
            <div className="p-8">
              ...
              <a href="/my-attempts" className="text-sm inline-flex items-center font-medium text-blue-900 hover:text-purple-900 transition-colors hover:underline">
                View My Attempts
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:translate-y-1 transform">
          <div className="relative">
            ...
            <div className="p-8">
              ...
              <a href="/" className="text-sm inline-flex items-center font-medium text-green-600 hover:text-green-800 transition-colors hover:underline">
                Browse Quizzes
                <svg className="w-4 h-4 ml-1 transform transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:translate-y-1 transform">
          <div className="relative">
            <div className="absolute top-0 right-0 h-24 w-24 bg-purple-100 rounded-bl-full opacity-30"></div>
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
      ...
      {/* Start Your Journey Section - Replaces "Recently Completed Quizzes" for new users */}
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        <div className="p-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800">Start Your Quiz Journey</h2>
            <a 
              href="/" 
                  ...
                  <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-2">
                        <div className={`text-sm px-3 py-1 rounded-full font-medium flex items-center ${
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="md:w-2/3 text-center md:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <a 
                      href="/categories" 
                      className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg font-medium hover:opacity-90 transition-all duration-300 shadow-md flex items-center justify-center"
                    >
              ...
              <div className="mt-10 pt-8 border-t border-blue-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {['Science', 'History', 'Technology', 'Arts & Literature'].map(category => (
                    <a 
                      key={category}
